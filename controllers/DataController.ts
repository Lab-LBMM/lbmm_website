...
export class DataController {
  ...
  static getNews(): News[] {
    return [
      {
        id: '1',
        title: 'New Publication on Computational Reproducibility',
    ...
    return [
      {
        id: '1',
        name: 'Blast Server',
        description: 'Public blast server providing access to datasets generated by members of the group.',
        type: 'server',
        link: '#',
        databases: [
          {
            name: 'B2.p_utg.GENOME',
            type: 'Nucleotide',
            description: 'Genome sequence of cultivar SP80-3280 version B2',
            sequences: 128247,
          },
        ],
      },
      {
        id: '2',
        name: 'PloidyNGS',
        description: 'Tool to visually exploit ploidy using Next Generation Sequencing data.',
        type: 'software',
        link: 'https://academic.oup.com/bioinformatics/article/33/16/2575/3104472',
      },
    ]
  ...
  static getTeaching(): Teaching[] {
    return [
      {
        id: '1',
        title: 'Brazilian Python Workshop for Biological Data',
        description: 'Workshop on Python programming for biological data analysis.',
        period: '2017 - 2022',
        type: 'workshop',
      },
      {
        id: '2',
        title: 'Python Workshop for Microbiology Data',
        description: 'Specialized workshop focusing on Python for microbiology data analysis.',
        period: '2021 - 2022',
        type: 'workshop',
      },
    ]
    ...
    return [
      {
        ...
        description: 'Researcher dedicated to advancing biological sciences through computational reproducibility.',
        type: 'current',
        category: 'principal_investigator',
        email: 'renatoacsantos@usp.br',
      },
      {
        id: '2',
        name: 'Postdoc Researcher Example',
        role: 'Post-doctoral Researcher',
        description: 'Working on computational reproducibility projects.',
        type: 'current',
        category: 'postdoc',
      ...
      {
        id: '3',
        name: 'PhD Student Example',
        role: 'PhD Student',
        description: 'Researching bioinformatics and multi-omics analysis.',
        type: 'current',
        category: 'phd',
      ...
      {
        id: '4',
        name: 'Master Student Example',
        role: 'Master Student',
        description: 'Working on microbial genomics projects.',
        type: 'current',
        category: 'masters',
      ...
      },
      {
        ...
        description: 'Completed PhD in 2023. Now working at...',
        type: 'alumni',
        category: 'alumni',
      },
    ]
